...
proc set_process_props {} {
   ...
   project set "Target UCF File Name" "/mnt/hgfs/MyProjects/str_trng/ise_proj/fpga_core.ucf" -process "Back-annotate Pin Locations"
   ...
   project set "Work Directory" "/mnt/hgfs/MyProjects/str_trng/ise_proj/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "fpga_core" -process "Generate IBIS Model"
